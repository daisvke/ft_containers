...
namespace ft
{
	...
	*************************************************************/
	...
	public:
		...
		typedef ft::random_access_iterator<false, value_type>	iterator;
		typedef ft::random_access_iterator<true, value_type>	const_iterator;
		...
		// [first,last). Note that the assignment completely changes the
		...
		// [first,last) into the vector before the location specified by position
		template <class InputIterator>
