...
// integral_constant
// wraps a static constant of specified type. It is the base class for the C++ type traits. Accepts static constant of type T with value v
...
// is_integral
/* Checks whether T is an integral type. Provides the member constant value which is equal to true, if T is the type bool, char, wchar_t, short, int, long, long long, or any implementation-defined extended integer types, including any signed, unsigned, and cv-qualified variants. Otherwise, value is equal to false. */
